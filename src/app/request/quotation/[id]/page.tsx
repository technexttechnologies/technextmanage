...
export default async function DynamicQuotationRequestPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const whatsappMessage = encodeURIComponent(`Hi! I have some questions regarding Proposal ${request.aroniumQuotationNo || request.id.slice(-6)}.`);
  ...
  return (
    <div className={styles.container}>
      <div className={styles.document}>
        ...
        <div className={styles.header}>
          ...
          <div className={styles.quoteMeta}>
            <h1 className={styles.quoteTitle}>PROPOSAL</h1>
            <div className={styles.metaGrid}>
              <div className={styles.metaLabel}>Ref #</div>
              <div className={styles.metaValue}>{request.aroniumQuotationNo || `REQ-${request.id.slice(-6).toUpperCase()}`}</div>
      ...
      <div className={styles.actionBar}>
        <QuotationRequestActionButtons requestId={request.id} currentStatus={request.status} />
